...
export const PRODUCTS: Product[] = [
  {
    ...
    description:
      'Cream streetwear tee with a minimal Racing chest hit and a bold back graphic inspired by the McLaren F1 era, finished with orange supercar artwork and vintage racing typography.',
  ...
  },
  {
    ...
    stockNote: 'New Launch',
    description:
      'Black 911-inspired graphic tee with a clean front number mark and a high-energy green race car back print, built around drifting club typography and night-vision details.',
    fabric: '100% Premium Cotton',
    fit: 'Oversized Fit',
  },
  {
  ...
  },
  {
    ...
    stockNote: 'New Launch',
    description:
      'Red statement tee with a small Behind chest print and a dramatic back graphic showing a swordsman holding chained blades, framed by oversized varsity-style lettering.',
    fabric: '100% Premium Cotton',
    fit: 'Oversized Fit',
  },
  {
  ...
  },
  {
    ...
    stockNote: 'New Launch',
    description:
      'Cream tee with a small spider chest mark and an oversized back print featuring a black spider, red web lines, and a bold number 4 for a clean graphic punch.',
    fabric: '100% Premium Cotton',
    fit: 'Oversized Fit',
  },
  {
  ...
  },
  {
    ...
    stockNote: 'New Launch',
    description:
      'White art tee with a small Reality chest graphic and a large back illustration blending sculpture texture, bold lettering, and an orange ape mask for a surreal streetwear look.',
    fabric: '100% Premium Cotton',
    fit: 'Oversized Fit',
  },
  {
