                  ...
                  {cart.map(item => (
                    <div key={item.cartId} className="flex gap-4 py-5 items-start group">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-sm font-black text-gray-900 mt-1.5">₹{item.product.price * item.qty}</p>
                    ...
                    {cart.map(item => (
                      <div key={item.cartId} className="flex justify-between">
                        <span className="text-gray-600 truncate mr-2">
                          {item.product.name} <span className="text-gray-400 font-medium">×{item.qty}</span>
                        </span>
                        <span className="font-black text-gray-900 flex-shrink-0">₹{item.product.price * item.qty}</span>
                      </div>
                    ))}
                  </div>
