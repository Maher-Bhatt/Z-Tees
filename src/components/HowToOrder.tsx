...
const steps = [
  {
    num: "01",
    title: "pick ur fit 👀",
    desc: "Browse the collection, find your design + size. easy.",
    color: "#FFE600",
    textColor: "#0D0D0D",
  },
  {
    num: "02",
    title: "slide in our dms 💬",
    desc: "Hit WhatsApp or Instagram. tell us: product, size, address. done.",
    color: "#FF2D78",
    textColor: "#FAFAFA",
  },
  {
    num: "03",
    title: "we ship it 🚚",
    desc: "Pay via UPI. we pack and dispatch. track your order. W.",
    color: "#CCFF00",
    textColor: "#0D0D0D",
  },
];
...
export default function HowToOrder() {
  ...
  return (
    <section
      id="how-to-order"
      ref={sectionRef}
      className="bg-brand-black py-20 px-4 sm:px-6"
    >
