  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3 items-end">
      ...
      <a
        ...
        className="btn-hover w-12 h-12 rounded-full flex items-center justify-center text-white shadow-lg"
        style={{
          background:
            "linear-gradient(45deg, #f09433 0%, #e6683c 25%, #dc2743 50%, #cc2366 75%, #bc1888 100%)",
          boxShadow: "0 4px 15px rgba(220, 39, 67, 0.5)",
        }}
      ...
      <a
        ...
        style={{
          padding: waHovered ? "0 20px 0 14px" : "12px",
          height: "48px",
      ...
      >
        ...
        <span
          className="font-accent font-bold text-sm whitespace-nowrap overflow-hidden transition-all duration-300"
          style={{
            maxWidth: waHovered ? "120px" : "0",
