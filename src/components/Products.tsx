...
const products: Product[] = [
  ...
  { id: 3, name: "GANG WALK", color: "Chocolate Brown",
    desc: "whole squad in a line. aesthetic af. minimalist but loud.",
    fullDesc: "A row of illustrated characters walking in sync — each one with their own drip. Printed on rich chocolate brown cotton. Minimalist concept, maximum personality.",
    price: "₹439", badge: "NEW DROP", badgeColor: "#CCFF00", badgeTextColor: "#0D0D0D",
    image: gangWalk, fabric: "100% Premium Cotton", fit: "Regular Fit", highlight: "Squad Goals. Always." },
